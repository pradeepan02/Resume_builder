...
import './Template6.css'; // Import the updated CSS file

const Template6 = ({ formData }) => {
    const generatePDF = () => {
        const input = document.getElementById('resume-template-6');
        html2canvas(input)
            .then((canvas) => {
    ...
    return (
        <div id="resume-template-6" className="resume-container">
